...
public class SensorItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMountablePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_label_feature", "_UI_Sensor_type"),
				 MajordomoPackage.Literals.SENSOR__LABEL,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Mountable feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMountablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_mountable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_mountable_feature", "_UI_Sensor_type"),
				 MajordomoPackage.Literals.SENSOR__MOUNTABLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MajordomoPackage.Literals.SENSOR__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Sensor)object).getLabel();
