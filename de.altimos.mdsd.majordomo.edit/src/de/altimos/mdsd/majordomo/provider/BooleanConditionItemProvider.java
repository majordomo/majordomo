...
/**
 * This is the item provider adapter for a {@link de.altimos.mdsd.majordomo.BooleanCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanConditionItemProvider
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BooleanCondition_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BooleanCondition_value_feature", "_UI_BooleanCondition_type"),
				 MajordomoPackage.Literals.BOOLEAN_CONDITION__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addSensorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BooleanCondition_sensor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BooleanCondition_sensor_feature", "_UI_BooleanCondition_type"),
				 MajordomoPackage.Literals.BOOLEAN_CONDITION__SENSOR,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		Comperator labelValue = ((BooleanCondition)object).getComperator();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_BooleanCondition_type") :
			getString("_UI_BooleanCondition_type") + " " + label;
	}
