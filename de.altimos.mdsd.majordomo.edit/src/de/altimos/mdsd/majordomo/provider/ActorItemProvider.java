...
public class ActorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MajordomoPackage.Literals.ACTOR__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Actor)object).getLabel();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Actor.class)) {
			case MajordomoPackage.ACTOR__LABEL:
			case MajordomoPackage.ACTOR__TYPE:
